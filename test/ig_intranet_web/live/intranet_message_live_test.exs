defmodule IgIntranetWeb.IntranetMessageLiveTest do
  ...
  describe "Index" do
    setup [:create_intranet_message, :create_recipient_user, :register_and_log_in_user]
    ...
    test "saves new intranet_message", %{conn: conn, user: user, recipient: recipient} do
      ...
      assert index_live
             ...
             valid_attrs = @create_attrs |> Map.merge(%{
              user_id: user.id,
              recipient_id: recipient.id
             })
      assert index_live
             |> form("#intranet_message-form", intranet_message: valid_attrs)
             |> render_submit()
  ...
  describe "Show" do
    setup [:create_intranet_message, :register_and_log_in_user, :create_recipient_user]
