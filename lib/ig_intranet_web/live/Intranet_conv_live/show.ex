defmodule IgIntranetWeb.IntranetConvLive.Show do
  ...
  def handle_params(%{"id" => id}, _, socket) do
    {:noreply,
     ...
     |> assign(:changeset, to_form(Chats.change_intranet_message(%IntranetMessage{})))
  ...
  @impl true
  def handle_event("send_message", %{"intranet_message" => intranet_message}, socket) do

      {:ok, message} = Chats.create_intranet_message(intranet_message)
